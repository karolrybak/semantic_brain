...
- **LINK_STRENGTH_BASE**: Podstawowa siła sprężystości linków. Jest modulowana przez dopasowanie połączonych węzłów do aspektów (silniejsze powiązania dla istotnych treści).
